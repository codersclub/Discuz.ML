...
/*vot*/ showboxrow('', array('class="dcol d-1 lineheight"', 'class="dcol lineheight team tm"'), array(
...
/*vot*/));
/*vot*/	showboxrow('', array('class="dcol d-1 lineheight"', 'class="dcol lineheight team tm"'), array(cplang('home_dev_links'),	'
/*vot*/	<a href="https://github.com/codersclub/Discuz.ML" class="lightlink2" target="_blank">Discuz!ML Git</a>,
/*vot*/	<a href="https://gitee.com/Discuz/DiscuzX" class="lightlink2" target="_blank">Discuz! X Git</a>,&nbsp;
