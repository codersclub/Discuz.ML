	...
	if(!submitcheck('submit')) {
		...
		foreach($plugins as $plugin) {
			...
			if(isset($_G['cache']['plugin'][$plugin['identifier']])) {
				//In order to cooperate with the plug-in to completely take over the variable setting function, when the first back-end setting module of the plug-in is config, the plug-in list does not display the default settings
				$configexists = FALSE;
