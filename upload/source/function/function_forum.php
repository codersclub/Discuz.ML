...
function insertpost($data) {
	if(isset($data['tid'])) {
		...
		// Third-party plug-ins and systems generally use insertpost to insert replies directly, so it is handled here instead
...
function viewthread_is_search_referer() {
	$regex = "((http|https)\:\/\/)?";
/*vot*/	$regex .= "([a-z]*.)?(yandex.com|yandex.ru|toutiao.com|m.sm.cn|www.so.com|sogou.com|bing.com|baidu.com|google.com|google.cn|google.com.hk)(.[a-z]{2,3})?\/";
