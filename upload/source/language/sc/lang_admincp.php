...
/*3.1*/	'founder_optimizer_security' => '安全测试',
/*3.1*/	'founder_optimizer_performance' => '性能优化',
/*3.1*/	'founder_optimizer_low' => '低',
/*3.1*/	'founder_optimizer_middle' => '中',
/*3.1*/	'founder_optimizer_high' => '高',
/*3.1*/	'founder_optimizer_level' => '安全级别',
/*3.1*/	'founder_optimizer_needopti' => '可优化项',
/*3.1*/	'founder_optimizer_safe' => '安全项',
/*3.1*/	'founder_optimizer_notice' => '提示项',
...
/*3.1*/	'home_security_service_close_info' => '<li>推荐您开通云平台, 开通后，当站点程序出现严重安全漏洞需要立即进行修补的时候，我们会通过QQ及时通知给您<br/><a href="?action=plugins">点击<strong>"云平台->开通Discuz!云平台"</strong>开通此功能</a></li>',
...
',
	...
	'setting_sec' => '基本设置',
/*3.1*/	'setting_seccheck' => '验证设置',
/*3.1*/	'setting_accountguard' => '帐号保镖',
...
/*3.1*/	'setting_sec_seccode_rule_setting' => '规则设置',
/*3.1*/	'setting_sec_seccode_type_setting' => '显示设置',
...
/*3.1*/	'setting_sec_seccode_cloudip' => '云端IP库检测',
/*3.1*/	'setting_sec_seccode_cloudip_comment' => '启用后当用户的登录 IP 在云端可疑 IP 库中时，用户的注册、登录、发表等操作会自动启用验证码',
/*3.1*/	'setting_sec_seccode_rule_min' => '分钟',
/*3.1*/	'setting_sec_seccode_rule_hour' => '小时',
/*3.1*/	'setting_sec_seccode_rule_register' => '注册时启用验证码',
/*3.1*/	'setting_sec_seccode_rule_register_comment' => '设置注册时验证码的启用规则',
/*3.1*/	'setting_sec_seccode_rule_register_auto' => '智能启用',
/*3.1*/	'setting_sec_seccode_rule_register_on' => '启用',
/*3.1*/	'setting_sec_seccode_rule_register_off' => '不启用',
/*3.1*/	'setting_sec_seccode_rule_register_numlimit' => '一段时间内注册上限',
/*3.1*/	'setting_sec_seccode_rule_register_numlimit_comment' => '当网站注册用户在选择的时间段内超过设置值时，全天用户注册均需要通过验证码验证，0 代表不启用此规则',
/*3.1*/	'setting_sec_seccode_rule_register_timelimit' => '时间段选择',

/*3.1*/	'setting_sec_seccode_rule_login' => '登录时启用验证码',
/*3.1*/	'setting_sec_seccode_rule_login_comment' => '设置登录时验证码的启用规则',
/*3.1*/	'setting_sec_seccode_rule_login_auto' => '智能启用',
/*3.1*/	'setting_sec_seccode_rule_login_on' => '启用',
/*3.1*/	'setting_sec_seccode_rule_login_off' => '不启用',
/*3.1*/	'setting_sec_seccode_rule_login_nolocal' => '异地登录时启用',
/*3.1*/	'setting_sec_seccode_rule_login_nolocal_comment' => '当用户本地登录 IP 为异地登录时启用验证码',
/*3.1*/	'setting_sec_seccode_rule_login_pwsimple' => '用户密码太简单时启用',
/*3.1*/	'setting_sec_seccode_rule_login_pwsimple_comment' => '当用户登录时使用的密码的长度与复杂度不符合后台设置时',
/*3.1*/	'setting_sec_seccode_rule_login_pwerror' => '尝试密码错误 2 次后启用',
/*3.1*/	'setting_sec_seccode_rule_login_numiptry' => '重复 IP 段尝试密码错误上限',
/*3.1*/	'setting_sec_seccode_rule_login_numiptry_comment' => '当一个 IP 段在选择的时间段内错误次数超过设置时，该 IP 段再次登录需要输入验证码，0 代表不启用此规则',
/*3.1*/	'setting_sec_seccode_rule_login_timeiptry' => '时间段选择',
/*3.1*/	'setting_sec_seccode_rule_login_outofday' => '长时间未登录后 (天)',
/*3.1*/	'setting_sec_seccode_rule_login_outofday_comment' => '当用户最近一次登录时间距离上次登录时间超过设置值时需要输入验证码，0 代表不启用此规则',

/*3.1*/	'setting_sec_seccode_rule_post' => '发表信息时启用验证码',
/*3.1*/	'setting_sec_seccode_rule_post_comment' => '设置发表信息时验证码的启用规则',
/*3.1*/	'setting_sec_seccode_rule_post_auto' => '智能启用',
/*3.1*/	'setting_sec_seccode_rule_post_on' => '启用',
/*3.1*/	'setting_sec_seccode_rule_post_off' => '不启用',
/*3.1*/	'setting_sec_seccode_rule_post_numlimit' => '用户一段时间内发帖操作总次数上限',
/*3.1*/	'setting_sec_seccode_rule_post_numlimit_comment' => '当用户在选择的时间段内发表主题，回复总数超过设置值时需要输入验证码，0 代表不启用此规则',
/*3.1*/	'setting_sec_seccode_rule_post_timelimit' => '时间段选择',
/*3.1*/	'setting_sec_seccode_rule_post_nplimit' => '提交主题时间太短后启用 (秒)',
/*3.1*/	'setting_sec_seccode_rule_post_nplimit_comment' => '用户打开发帖页面到提交的最短时间，低于最短设置时间时需要输入验证码，0 代表不启用此规则',
/*3.1*/	'setting_sec_seccode_rule_post_vplimit' => '提交回复时间太短后启用 (秒)',
/*3.1*/	'setting_sec_seccode_rule_post_vplimit_comment' => '用户打开帖子页面到提交回复的最短时间，低于最短设置时间时需要输入验证码，0 代表不启用此规则',

/*3.1*/	'setting_sec_seccode_rule_password' => '修改密码时启用验证码',
/*3.1*/	'setting_sec_seccode_rule_password_comment' => '设置修改密码时是否启用验证码',

/*3.1*/	'setting_sec_seccode_rule_card' => '充值卡密时启用验证码',
/*3.1*/	'setting_sec_seccode_rule_card_comment' => '设置充值卡密时是否启用验证码 (推荐开启)',
...
/*3.1*/	'setting_sec_accountguard'=> '帐号保镖',
...
/*3.1*/	'setting_sec_accountguard_forcelogin' => '安全登录',
/*3.1*/	'setting_sec_accountguard_forcelogin_comment' => '设置用户组的用户是否强制使用指定的登录方式',
/*3.1*/	'setting_sec_accountguard_postqqonly' => '发帖需要绑定QQ号',
/*3.1*/	'setting_sec_accountguard_postqqonly_comment' => '开启后用户发帖必须先绑定QQ号',
/*3.1*/	'setting_sec_accountguard_loginpwcheck' => '弱密码登录检测',
/*3.1*/	'setting_sec_accountguard_loginpwcheck_comment' => '当用户登录时使用的密码强度不符合“全局>注册与访问控制>注册>强制密码复杂度”设置时的操作。若启用强制修改，弱密码帐号会被暂时冻结，修改密码成功后自动解除',
/*3.1*/	'setting_sec_accountguard_loginpwcheck_none' => '不开启',
/*3.1*/	'setting_sec_accountguard_loginpwcheck_prompt' => '开启并提示',
/*3.1*/	'setting_sec_accountguard_loginpwcheck_force' => '开启并强制修改弱密码',
/*3.1*/	'setting_sec_accountguard_loginoutofdate' => '异常登录检测',
/*3.1*/	'setting_sec_accountguard_loginoutofdate_comment' => '当用户异地登录且距离上次登录超过 90 天时，帐号会进入未审核组，用户可以通过验证邮箱或者申诉解冻帐号，QQ登录的用户不受此功能影响 <a href="'.ADMINSCRIPT.'?frames=yes&action=moderate&operation=members">审核用户</a>',
...
/*3.1*/	'styles_edit' => '编辑风格',//EXISTS BELOW
...
/*3.1*/	'styles_default' => '默认风格',
/*3.1*/	'styles_default0' => '电脑版',
/*3.1*/	'styles_default1' => '手机标准版',
/*3.1*/	'styles_default2' => '手机触屏版',
/*3.1*/	'styles_default3' => '手机极简版',
...
/*3.1*/	'members_search_freezestatus' => '是否冻结',
...
/*3.1*/	'usergroups_edit_basic_forcelogin' => '安全登录方式',
/*3.1*/	'usergroups_edit_basic_forcelogin_comment' => '选择此用户组用户安全登录的方式',
/*3.1*/	'usergroups_edit_basic_forcelogin_none' => '不开启',
/*3.1*/	'usergroups_edit_basic_forcelogin_qq' => 'QQ登录',
/*3.1*/	'usergroups_edit_basic_forcelogin_mail' => '邮箱登录',
...
/*3.1*/	'plugins_edit_modules_param' => '模块参数',
...
/*3.1*/	'plugins_edit_modules_type_29' => '管理中心 - 列表链接',
...
/*3.1.1*/	'card_config_open_comment' => '设置是否允许前台充值，关闭前台充值功能，不影响后台卡密的生成<br />充值卡密验证码开关：<a href="'.ADMINSCRIPT.'?action=setting&operation=seccheck">全局->防灌水->验证设置</a>',
	'card_number' =>'卡密',
	'card_number_unit' => '位',
...
/*3.1*/	'optimizer_security_tips' => '<li>体检可以帮助您发现网站问题，消除安全风险</li><li>设置项安全检测</li><li>产品新版本及安全补丁检测</li><li>安装插件安全及更新检测</li>',
...
/*3.1*/	'optimizer_check_unit_optimizer_inviteregister' => '检测允许新用户注册项',
/*3.1*/	'optimizer_check_unit_optimizer_emailregister' => '检测通过邮件发送注册连接项',
/*3.1*/	'optimizer_check_unit_optimizer_pwlength' => '检测密码最小长度项',
/*3.1*/	'optimizer_check_unit_optimizer_regmaildomain' => '检测注册邮箱域名限制',
/*3.1*/	'optimizer_check_unit_optimizer_ipregctrl' => '检测限时注册的 IP 列表项',
/*3.1*/	'optimizer_check_unit_optimizer_newbiespan' => '检测新手见习期限',
/*3.1*/	'optimizer_check_unit_optimizer_editperdel' => '检测允许用户编辑帖子时删除帖子项',
/*3.1*/	'optimizer_check_unit_optimizer_recyclebin' => '检测版块是否开启回收站',
/*3.1*/	'optimizer_check_unit_optimizer_forumstatus' => '检测隐藏版块是否设置访问权限',
/*3.1*/	'optimizer_check_unit_optimizer_usergroup9' => '检测限制会员用户组权限设置',
/*3.1*/	'optimizer_check_unit_optimizer_usergroup4' => '检测禁止发言用户组权限设置',
/*3.1*/	'optimizer_check_unit_optimizer_usergroup5' => '检测禁止访问用户组权限设置',
/*3.1*/	'optimizer_check_unit_optimizer_usergroup6' => '检测禁止IP用户组权限设置',
/*3.1*/	'optimizer_check_unit_optimizer_cloudsecurity' => '检测防水墙设置',
/*3.1*/	'optimizer_check_unit_optimizer_attachexpire' => '检测防盗链设置',
/*3.1*/	'optimizer_check_unit_optimizer_attachrefcheck' => '检测下载附件来路检查设置',
/*3.1*/	'optimizer_check_unit_optimizer_loginpwcheck' => '检测弱密码登录检测是否开启提示或者强制修改密码',
/*3.1*/	'optimizer_check_unit_optimizer_loginoutofdate' => '检测异地登录检测是否开启',
/*3.1*/	'optimizer_check_unit_optimizer_eviluser' => '检测防水墙违规用户',
/*3.1*/	'optimizer_check_unit_optimizer_white_list' => '检测防水墙白名单',
/*3.1*/	'optimizer_check_unit_optimizer_security_daily' => '检测是否开启防水墙每日优化计划任务',
/*3.1*/	'optimizer_check_unit_optimizer_postqqonly' => '检测发帖需要绑定QQ号检测是否开启',
/*3.1*/	'optimizer_check_unit_optimizer_aggid' => '检测“管理员，超级版主，版主”QQ登录检测是否开启',
