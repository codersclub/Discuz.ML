...
$lang = array(
	...
	'database_import_multivol_succeed'	=> '分卷数据成功导入站点数据库<br />请在后台更新缓存<br /><span class="red">出于安全考虑，我们强烈建议您恢复数据库备份文件后删除数据库数据库备份文件或设置数据库备份文件不可通过 URL 访问，以保证网站安全。</span><br /><span class="red">请尽快删除restore.php文件，以免对数据造成影响</span>',//'Volume data successfully imported into the site database<br />Please update the cache in the background<br /><span class="red">For security reasons, we strongly recommend that you delete the database after restoring the database backup file Database backup files or settings database backup files are not accessible via URL for website security.</span><br /><span class="red">Please delete the restore.php file as soon as possible to avoid affecting the data</span>',
	...
	'database_import_succeed'		=> '数据已成功导入站点数据库<br />请在后台更新缓存<br /><span class="red">出于安全考虑，我们强烈建议您恢复数据库备份文件后删除数据库数据库备份文件或设置数据库备份文件不可通过 URL 访问，以保证网站安全。</span><br /><span class="red">请尽快删除restore.php文件，以免对数据造成影响</span>',//'The data has been successfully imported into the site database<br />Please update the cache in the background<br /><span class="red">For security reasons, we strongly recommend that you delete the database database after restoring the database backup file Backup files or settings database backup files are not accessible via URL for website security.</span><br /><span class="red">Please delete the restore.php file as soon as possible to avoid affecting the data</span>',
