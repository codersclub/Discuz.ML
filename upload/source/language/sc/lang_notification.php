...
/*vot*/	'reason_warn_post' => '您的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} {modaction}<br />
...
/*vot*/	'magics_receive' => '您收到 {actor} 送给您的道具 {magicname}
