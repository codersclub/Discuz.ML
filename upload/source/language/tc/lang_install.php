...
<p>用戶須知：本協議是您與騰訊雲公司之間關於您使用騰訊雲公司提供的各種軟件產品及服務的法律協議。無論您是個人或組織、盈利與否、用途如何（包括以學習和研究為目的），均需仔細閱讀本協議，包括免除或者限制騰訊雲責任的免責條款及對您的權利限制。請您審閱並接受或不接受本服務條款。如您不同意本服務條款及/或騰訊云隨時對其的修改，您應不使用或主動取消騰訊雲公司提供的騰訊雲產品。否則，您的任何對騰訊雲產品中的相關服務的註冊、登陸、下載、查看等使用行為將被視為您對本服務條款全部的完全接受，包括接受騰訊雲對服務條款隨時所做的任何修改。 </p>
...
<li>您可以在完全遵守本許可協議的基礎上，將本軟件應用於非商業用途或商業用途使用（局限於本協議所適配許可的情況下），而不必支付軟件版權許可費用。</li>
   ...
   <li>若您需將騰訊雲軟件或服務用戶商業用途，必須遵守中國人民共和國相關法律。若需提供技術支持方式或技術支持內容，請向官方（https://www.discuz.net/）提供技術支持服務。</li>
...
<ol>
   ...
   <li>您從應用中心下載的應用程序，未經應用程序開發者/所有者的書面許可，不得對其進行反向工程、反向彙編、反向編譯等，不得擅自複制、修改、鏈接、轉載、彙編、發表、出版、發展與之有關的衍生產品、作品等。 </li>
...
<ol>
   ...
   <li>用戶出於自願而使用本軟件，您必須了解使用本軟件的風險，我們不承諾提供任何形式的技術支持、使用擔保，也不承擔任何因使用本軟件而產生問題的相關責任。 </li>
