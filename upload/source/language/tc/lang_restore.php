...
$lang = array(
	...
	'db_import_tips'	=> '本功能在恢復備份數據的同時，將全部覆蓋原有數據，請確定恢復前已將論壇關閉，恢復全部完成後可以將論壇重新開放。<br />您可以通過數據備份管理功能查看站點的備份文件的詳細信息，刪除過期的備份,並導入需要的備份。<br /><span class="red">出於安全考慮，我們強烈建議您恢復數據庫備份文件後刪除數據庫數據庫備份文件或設置數據庫備份文件不可通過 URL 訪問，以保證網站安全。</span><br /><span class="red">恢復數據的整個過程會在一個新頁面完成，您成功恢復數據後請務必及時刪除restore.php文件。</span><br />',
	...
	'db_export_custom'	=> '自定義備份',//'Custom backup',
	...
	'database_import_multivol_succeed'	=> '分卷數據成功導入站點數據庫<br />請在後台更新緩存<br /><span class="red">出於安全考慮，我們強烈建議您恢復數據庫備份文件後刪除數據庫數據庫備份文件或設置數據庫備份文件不可通過 URL 訪問，以保證網站安全。</span><br /><span class="red">請盡快刪除restore.php文件，以免對數據造成影響</span>',
	...
	'database_import_succeed'		=> '數據已成功導入站點數據庫<br />請在後台更新緩存<br /><span class="red">出於安全考慮，我們強烈建議您恢復數據庫備份文件後刪除數據庫數據庫備份文件或設置數據庫備份文件不可通過 URL 訪問，以保證網站安全。</span><br /><span class="red">請盡快刪除restore.php文件，以免對數據造成影響</span>',
