...
//static/js/common.js
	...
	'sms_sent_ok'		: '發送成功',//'Sent successfully',
	'sms_often'		: '發送短信間隔過短，請稍候再試。 ',//'The interval between sending SMS is too short, please try again later.',
	'sms_many_total'	: '您一段時間內發送的短信過多，請稍候再試。 ',//'You have sent too many text messages in a while, please try again later.',
	'sms_many_in_period'	: '號碼組一段時間內發送的短信過多，請稍候再試。 ',//'The number group has sent too many text messages in a period of time, please try again later.',
	'sms_many_in_site'	: '本站點一段時間內發送的短信過多，請稍候再試。 ',//'This site has sent too many text messages in a period of time, please try again later.',
	'sms_gate_not_available'	: '當前沒有可用的短信網關接口，請稍候再試。 ',//'There is currently no SMS gateway interface available, please try again later.',
	'sms_gate_not_found'	: '網關接口文件不存在，請稍候再試。 ',//'Gateway interface file does not exist, please try again later.',
	'sms_class_not_found'	: '網關接口類不存在，請稍候再試。 ',//'Gateway interface class does not exist, please try again later.',
	'sms_disabled'		: '短信功能已被關閉，請稍候再試。 ',//'Text messaging has been disabled, please try again later.',
	'sms_gate_invalid'	: '短信網關異常，請稍候再試。 ',//'The SMS gateway is abnormal, please try again later.',
	'sms_exception'		: '未知異常，請稍候再試。 ',//'Unknown exception, please try again later.',
	'sms_failed'		: '發送失敗，錯誤代碼 ',//'Failed to send, error code ',
...
//static/js/editor.js
	...
	'download_remote'	: '正在下載遠程附件，請稍等……',//'Downloading remote attachment, please wait ...',
	'create_post_directory'	: '創建帖子目錄',//'Create post directory',
	'page_number'		: '頁碼',//'Page number',
	'jump_to_page'		: '跳轉到指定的頁',//'Jump to specified page',
	'jump_to_page_comment'	: '用 [page] 對當前帖子分頁後的頁碼',//'Use [page] tag for add a page break',
	'jump_to_post'		: '跳轉到指定的帖子',//'Jump to specified post',
	'jump_tip_pid'		: '帖子的 TID 和 PID',//'Post TID and PID',
	'add_indent'		: '添加行首縮進',//'Add the first line indent',
	'enter_post_password'	: '請輸入帖子密碼',//'Please enter the post password',
	'begin_flash_img'	: '請輸入開頭動畫 Flash 或 圖片 地址',//'Enter the beginning Flash or image animation URL',
	'begin_click_url'	: '點擊鏈接地址',//'Click on the link URL',
	'begin_stay_seconds'	: '停留秒數',//'Display seconds',
	'begin_disappearance'	: '載入、消失的效果',//'Disappear effect after loading',
	'none'			: '無',//'None',
	'begin_fade'		: '淡入淡出',//'Fade',
	'begin_explosive'	: '展開閉合',//'Explode',
	'begin_info'		: '支持 swf flv jpg gif png 網址<br />寬高範圍: 寬400~1024 高300~640<br />示例: http://server/flash.swf',//'Supported formats: swf flv jpg gif png<br/>Width range: 400~1024, Height range: 300~640<br/>Example: http://server/flash.swf',
...
//static/js/forum.js
	...
	'seconds'		: ' 秒',//' sec.',
	'thread_title_length_invalid'	: '您的標題長度不符合要求。 ',
...
//static/js/forum_post.js
	...
	'today_upload_large'	: '今日您已無法上傳那麼大的附件',//'Today you can not upload so much attachments',
	'bad_words'		: '因文件名包含敏感詞而無法提交',//'Unable to submit because the file name contains sensitive words',
	'high_resolution'	: '服務器限制無法上傳分辨率過高的附件',//'Server restrictions prevent uploading high resolution attachments',
...
//	'upload_failed'		: '上傳失敗',
	...
	'delete_post_failed'	: '抱歉，刪除操作失敗，請刷新頁面後重試。 ',//'Sorry, the delete operation failed, please refresh the page and try again.',
...
//static/js/forum_viewthread.js
	...
	'quote_by'		: '本帖最後由 .*? 於 .*? 編輯',
	'copy_code'		: '複製代碼',
	'download_pocket_forum'	: '下載掌上論壇',//'Download Pocket Forum',
	'pocket_forum_android'	: 'Andriod版本，掃描二維碼可以直接下載到手機',//'If Andriod version, Scan thw QR-code can be downloaded directly to the phone',
	'pocket_forum_android_alt'	: '適用於裝有安卓系統的三星/HTC/小米等手機',//'Suitable for Android-based smartphones like Samsung/HTC/etc',
	'pocket_forum_ios'	: 'iPhone版本，掃描二維碼可以直接下載到手機',//'If iPhone used, Scan thw QR-code can be downloaded directly to the phone',
	'pocket_forum_ios_alt'	: '適用於蘋果手機',//'Suitable for Apple mobile phone',
	'quick_reply_here'	: '#在這裡快速回复#',//'#Quick Reply Here#',
	'set_cover'		: '設為封面',//'Set as cover',
	'source'		: '出處',//'Source',
	'view_all'		: '查看所有',//'View All',
	'index'			: '目錄',//'Thread Index',
...
//static/js/handlers.js
	...
	'upload_error'		: '上傳錯誤：',//'Upload Error: ',
	'config_error'		: '配置錯誤',//'Configuration Error',
	'server_error'		: '服務器（IO）錯誤'，//'Server (IO) Error',
	'security_error'	: '安全錯誤',//'Security Error',
	'upload_limit_exceed'	: '超過上傳限制。',//'Upload limit exceeded.',
	'file_not_found'	: '找不到文件。',//'File not found.',
	'validation_failed'	: '驗證失敗。上傳已跳過。',//'Failed Validation. Upload skipped.',
...
//static/js/makehtml.js
	...
	'generate_error'	: '生成失敗',//' generation failed',
	'generate_start'	: '開始生成 ',//'Start generating of ',
	'generate_click_continue'	: '如果您的瀏覽器沒有反應，請點擊繼續...',//'If your browser does not respond, Click to continue...',
	...
	'generate_percent'	: '已經完成 ',//'has been completed ',
...
//static/js/mobile/common.js
	...
	'click_to_reload'	: '點擊重新加載',//'Click to reload',
	'loading_now'		: '正在加載...',//'Loading...',

	'geo_timeout'		: '獲取位置超時，請重試',//'Get location timeout, please try again',
	'geo_error'		: '無法檢測到您的當前位置',//'Unable to detect your current location',
	'geo_permission'	: '請允許能夠正常訪問您的當前位置',//'Please allow normal access to your current location',
	'unknown_error'		: '發生未知錯誤',//'Unknown error occurred',
	'touch_down_refresh'	: '下拉可以刷新',//'Touch down to refresh',
	'touch_up_refresh'	: '鬆開可以刷新',//'Touch UP to refresh',
	'form_submit_error'	: '表單提交異常，無法完成您的請求',//'Form submission exception, unable to complete your request',
	'copy_failed'		: '複製失敗',//'Copy failed',
