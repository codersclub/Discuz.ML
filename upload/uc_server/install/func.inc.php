...
function authcode($string, $operation = 'DECODE', $key = '', $expiry = 0) {
	...
	//Dynamic key length, the same string and key can generate different ciphertexts through dynamic keys, improving security
	$ckey_length = 4;
	...
	// Shuffle the keybook to increase randomness
	...
	// Obtain the key from the key book for XOR, and then convert it into a character
	...
	if($operation == 'DECODE') {
		...
		// $result 01 - 10 digits are the time, if it is less than the current time or 0 then pass
		// $result 10 - 26 digits are the $keyb during encryption, and need to be compared with the $keyb entered as a parameter
