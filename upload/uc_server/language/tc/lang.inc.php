...
/*vot*/ define('UC_VERNAME', '國際版');//International Version
...
<h3>I. 協議許可的權利</h3>
<ol>
<li>您可以在完全遵守本最終用戶授權協議的基礎上，將本軟件應用於非商業用途或商業用途使用（局限於本協議所適配許可的情況下），而不必支付軟件版權授權費用。</li>
<li>您可以在協議規定的約束和限制範圍內修改 UCenter 源代碼(如果被提供的話)或界面風格以適應您的網站要求。</li>
<li>您擁有使用本軟件構建的網站中全部會員資料、文章及相關信息的所有權，並獨立承擔與文章內容的相關法律義務。</li>
<li>將本軟件應用於商業用途，必須遵守中國人民共和國相關法律。若需提供技術支持方式或技術支持內容，請向官方（https://www.discuz.vip/）獲取技術支持服務。</li>
</ol>

<h3>II. 協議規定的約束和限制</h3>
<ol>
<li>不得對本軟件或與之關聯的商業授權進行出租、出售、抵押或發放子許可證。</li>
<li>無論如何，即無論用途如何、是否經過修改或美化、修改程度如何，只要使用 UCenter 的整體或任何部分，未經書面許可，頁面頁腳處的 UCenter 名稱和下屬網站（https://www.discuz.vip） 的鏈接都必須保留，而不能清除或修改。</li>
...
<p>電子文本形式的授權協議如同雙方書面簽署的協議一樣，具有完全的和等同的法律效力。您一旦開始安裝 UCenter，即被視為完全理解並接受本協議的各項條款，在享有上述條款授予的權力的同時，受到相關的約束和限制。協議許可範圍以外的行為，將直接違反本授權協議並構成侵權，我們有權隨時終止授權，責令停止損害，並保留追究相關責任的權力。</p></div>',
	...
	'advice_file_get_contents' => '該函數需要 php.ini 中 allow_url_fopen 選項開啟。請聯繫服務商，確定開啟了此項功能',
