...
class usercontrol extends base {
	...
	function onlogin() {
		...
		// check_times represents the number of times that the user is allowed to fail to log in. The value of this variable is 0, which is unlimited, and the positive number is the number of times
		...
		if($isuid == 1) {
			...
			// isuid == 4 It is mobile phone number login, isuid == 3 has been occupied by the application
		...
		if(empty($user)) {
			...
			// Password upgrade is a subsidiary process, and the failure does not affect the login operation
