...
/*vot*/ $allow_method = array('show_license', 'env_check', 'app_reg', 'db_init', 'ext_info', 'install_check', 'tablepre_check', 'do_db_init', 'do_db_data_init', 'do_db_innodb', 'check_db_init_progress', 'language');
...
/*vot*/		header("Location: index.php?step=3&install_ucenter=".getgpc('install_ucenter')."&language=$language");
		die;
	}
	$submit = true;
	$error_msg = array();
