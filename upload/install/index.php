...
/*vot*/		echo '<p align="center"><a class="finish" href="'.$default_appurl.'">'.$lang['install_finish'].'</a></p><br /><br />'.$lang['ext_info'].'<hr>';
		echo '<iframe frameborder="0" width="700" height="550" allowTransparency="true" src="https://addon.discuz.com/api/outer.php?id=installed&siteurl='.urlencode($default_appurl).'&version='.DISCUZ_VERSION.'"></iframe>';
		echo '</div>';
		show_footer();
	}
