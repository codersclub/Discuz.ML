...
CREATE TABLE pre_common_smsgw (
  `smsgwid` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `available` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE pre_common_smslog (
  `smslogid` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(11) unsigned NOT NULL,
  `smstype` int(11) NOT NULL DEFAULT '0',
  `svctype` int(11) NOT NULL DEFAULT '0',
  `smsgw` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE pre_common_plugin (
  ...
  image VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'vot: Plugin Icon Image',
...
CREATE TABLE pre_common_task (
  ...
  exclusivetaskid int(11) unsigned NOT NULL DEFAULT '0',
  available tinyint(1) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE pre_common_payment_order  (
  ...
  `amount_fee` int(11) unsigned NOT NULL,
  ...
  `payment_time` int(11) unsigned DEFAULT NULL,
...
CREATE TABLE pre_forum_trade (
  ...
  account varchar(255) NOT NULL,
  tenpayaccount varchar(20) NOT NULL DEFAULT '',
  `subject` varchar(255) NOT NULL,
