...
/*vot*/		showmessage(lang('space_home_error'));
	}
...
if($nextid) {
/*vot*/	showmessage(lang('continue_convert_table'). " {$oldpre}space uid> $nextid", "index.php?a=$action&source=$source&prg=$curprg&start=$nextid");
}
